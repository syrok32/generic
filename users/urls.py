...
from users.views import PaymentListAPIView, UserCreateAPIView, UserDeleteAPIView, UserUpdateAPIView, \
    UserRetrieveAPIView, UserListAPIView, PaymentCreateAPIView
